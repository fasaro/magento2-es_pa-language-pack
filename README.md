...
composer require fasaro/magento2-es_pa-language-pack dev-master
php bin/magento setup:static-content:deploy es_PA
...
```
php bin/magento maintenance:enable
composer update fasaro/magento2-es_pa-language-pack dev-master
php bin/magento setup:static-content:deploy es_PA
php bin/magento indexer:reindex
php bin/magento cache:clean
php bin/magento cache:flush
